"""
Professional BOL PDF Generation using ReportLab - HICKMAN WILLIAMS SAMPLE
Designed for black & white laser printers

THIS IS A SAMPLE GENERATOR FOR VISUALIZING BLIND SHIPPING WITH HW BRANDING
"""
...
def generate_bol_pdf(bol_data, output_path=None):
    """
    Generate a professional BOL PDF with HICKMAN WILLIAMS branding
    ...
    # Header table: Title + BOL Number (no logo)
    header_data = [[
    ...
    # *** MODIFIED: Changed "c/o PrimeTrade, LLC" to "c/o Hickman, Williams & Company" ***
    left_col_data = [
        [Paragraph('<b>SHIP FROM:</b>', header_style)],
        [Paragraph('<b>Cincinnati Barge & Rail Terminal, LLC</b><br/>c/o Hickman, Williams & Company<br/>1707 Riverside Drive<br/>Cincinnati, Ohio 45202<br/>Phone: (513) 721-1707', normal_style)],
        [Spacer(1, 0.05*inch)],
